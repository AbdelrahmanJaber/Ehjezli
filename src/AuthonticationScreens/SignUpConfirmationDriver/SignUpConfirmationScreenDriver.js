...
const SignUpConfirmationScreenDriver = ({navigation}) => {

    const { signup_confirmation_driver, reset_signup_confirmation_driver} = useContext(AuthContext);
...
export default SignUpConfirmationScreenDriver

SignUpConfirmationScreenDriver.navigationOptions = () => {
    return {
      headerShown: false,
    };
  };
