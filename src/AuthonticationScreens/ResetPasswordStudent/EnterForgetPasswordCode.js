...
const EnterForgetPasswordCode = ({navigation}) => {
    ...
    const validate = () => {
        if (!number1 || !number2 || !number3 || !number4) {
            ...
            ResetPassword_confirmation_student({code});
        }
    }
                        ...
                        />
                         ...
                         {/* Button */}
                            ...
                            <View style = { styles.HaveAccountContainer}>
                                ...
                                <TouchableOpacity
                                onPress = { () => { reset_ResetPassword_confirmation_student() } }
                                >
...
EnterForgetPasswordCode.navigationOptions = () => {
    return {
      headerShown: false,
