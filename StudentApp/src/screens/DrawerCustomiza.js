...
const DrawerCustomiza = () => {
  const Code = useSelector((state) => state.entities.codeAndGate.Code);
  const Gate = useSelector((state) => state.entities.codeAndGate.Gate);
    ...
    <View style={{ backgroundColor: "#212121", padding: 15 }}>
      ...
      >
        {avatarRedux === "" ? (
          ...
          <Avatar size="medium" rounded source={{ uri: avatarRedux }} />
        )}
      ...
      {Code === "" ? null : (
        ...
        >
          ...
          <Text style={{ color: "#dddddd", paddingVertical: 5 }}>{Code}</Text>
        </View>
      )}
      ...
      {Code === "" ? null : (
        ...
        >
          ...
          <Text style={{ color: "#dddddd", paddingVertical: 5 }}> {Gate} </Text>
        </View>
      )}
    </View>
  );
...
export default DrawerCustomiza;
